...
const Common = {
    ...
    handleUnauthorized: async (): Promise<string | null> => { // refreshToken 파라미터 제거 및 반환 타입 명확화 (string | null)
        ...
        try {
            const response: AxiosResponse<Token> = await axios.post( // POST 요청으로 변경 (일반적인 refreshToken API 방식)
